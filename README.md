...
- **由于cocos2d-x不再维护，加之iOS上架麻烦，本项目不再维护，[新项目](https://github.com/summerinsects/ChineseOfficialMahjongHelper-Android)决定放弃iOS，使用Android原生重写**
- **Classes/mahjong-algorithm文件夹下为算番、判断听牌、听牌计算、上听数计算、有效牌计算等相关算法，已经独立成一个[项目](https://github.com/summerinsects/mahjong-algorithm)**
