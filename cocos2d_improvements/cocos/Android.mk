...
LOCAL_CFLAGS   +=  -DCC_USE_PHYSICS=0
LOCAL_CFLAGS   +=  -DCC_USE_3D_PHYSICS=0
LOCAL_CFLAGS   +=  -DCC_USE_NAVMESH=0
LOCAL_CFLAGS   +=  -DCC_ENABLE_BULLET_INTEGRATION=0
LOCAL_CFLAGS   +=  -DCC_USE_TIFF=0
LOCAL_CFLAGS   +=  -DCC_USE_WEBP=0
LOCAL_CFLAGS   +=  -DCC_ENABLE_SCRIPT_BINDING=0
