...
namespace UICommon {
    ...
    static inline cocos2d::ui::CheckBox *createCheckBox() {
        return cocos2d::ui::CheckBox::create("source_material/btn_square_normal.png", "", "source_material/btn_square_highlighted.png", "source_material/btn_square_disabled.png", "source_material/btn_square_disabled.png");
    }
